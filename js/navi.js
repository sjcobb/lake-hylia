...
var spriteMaterial = new THREE.SpriteMaterial({ 
  map: loader.load( '//sjcobb.github.io/lake-hylia/assets/navi/glow.png' ), 
...
audioLoader.load( '//sjcobb.github.io/lake-hylia/assets/navi/OOT_Navi_Listen1.wav', function( buffer ) {
